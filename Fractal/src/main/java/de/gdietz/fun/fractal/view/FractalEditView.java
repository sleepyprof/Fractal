...
public class FractalEditView extends JPanel implements FractalView {

	private final FractalModel<?> model;
	private final FractalController<Coordinate> controller;
	...
	public FractalEditView(FractalModel<?> model, FractalController<Coordinate> controller) {
