...
public class FractalPrecisePictureImpl<D> implements FractalPicture<BigCoordinate> {

	private final FractalPreciseModel<D> model;

    private final ColorStrategy<D> coloring;

	public FractalPrecisePictureImpl(FractalPreciseModel<D> model, ColorStrategy<D> coloring) {
		this.model = model;
