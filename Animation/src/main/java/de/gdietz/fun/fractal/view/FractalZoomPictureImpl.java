...
public class FractalZoomPictureImpl<D> implements FractalAnimPicture<Coordinate>, ImageDeliverer {

    private final FractalZoomModel<D> model;

    private final ColorStrategy<D> coloring;

    private Component parent;

    public FractalZoomPictureImpl(FractalZoomModel<D> model, ColorStrategy<D> coloring) {
        this.model = model;
    ...
    public Coordinate getCoordinate(int x, int y) {
        return model.getCoordinate(x, y, 0);
    }
